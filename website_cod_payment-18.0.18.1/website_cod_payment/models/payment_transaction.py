...
from odoo.addons.website_cod_payment.controllers.main import CODController
...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        return {
            'api_url': CODController._process_url,
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if not tx:
            raise ValidationError(
                "COD Transfer: " + _("No transaction found matching reference %s.", reference)
            )
        return tx
    ...
    def _get_cod_communication(self):
